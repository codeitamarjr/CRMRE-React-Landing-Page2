            ...
            <div className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p className="mt-2 text-lg/8 text-gray-600">Follow our blog for the latest news and updates.</p>
                    </div>
                            ...
                            <article key={post.slug} className="flex max-w-xl flex-col items-start justify-between">
                                ...
                                <div className="group relative">
                                    <Link href={`/blog/${post.slug}`}>
                                        <h3 className="mt-3 text-lg/6 font-semibold text-indigo-600 hover:underline">
